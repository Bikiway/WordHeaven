...
namespace WordHeaven_Web.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(IConverterHelper converterHelper, IEmailHelper emailHelper, IEmployeeRepository employeeRepository, IUserHelper userHelper, IConfiguration configuration)
        {
